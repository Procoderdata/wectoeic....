    ...
    <div className="sat-landing-page">
      <header className="sat-landing-nav-wrap">
        <div className="sat-landing-nav">
          <Link className="sat-brand" to="/">
            <span className="sat-brand-icon">✪</span>
            <span>BloomPrep</span>
          </Link>
            ...
            {currentUser ? (
              <>
                ...
                <Link className="sat-google-btn" to="/home">
                  <span className="sat-google-g">→</span>
                  Vào học
                </Link>
      ...
      <section className="sat-hero">
        <div className="sat-hero-copy">
          <span className="sat-kicker">✨ Luyện TOEIC + Aptis thông minh</span>
          <h2>
            Chinh phục TOEIC & Aptis, <span>Dễ dàng</span> hơn mỗi ngày!
          </h2>
          <p>
            Nền tảng học tập tập trung từ vựng, reading, mock test và lộ trình video
            để bạn học đều mỗi ngày và tăng điểm thi thật.
          </p>
        ...
        <article className="sat-progress-card">
          ...
          <Link className="sat-progress-cta" to="/toeic/exam/reading">
            Tiếp tục học
          </Link>
        </article>
      </section>
