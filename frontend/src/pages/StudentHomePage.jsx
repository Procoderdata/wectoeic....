    ...
    <div className="home-page">
      <section className="hero-panel home-hero">
        <div className="hero-copy">
          <span className="pill pastel-blue">Student Dashboard</span>
          <h2>Xin chào {user.username}, tiếp tục kế hoạch học hôm nay</h2>
          <p>
            Theo dõi tiến độ TOEIC + Aptis theo dữ liệu thực tế, mở nhanh kỹ năng cần cải thiện
            và duy trì nhịp học ổn định.
          </p>
          ...
          <div className="hero-actions">
            ...
            <Link className="ghost-btn" to="/toeic/tests">
              Full Test
            </Link>
          </div>
        </div>
