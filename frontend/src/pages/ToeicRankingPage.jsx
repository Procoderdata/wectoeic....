...
const rankingTabs = [
  { key: 'xp', label: 'XP Tổng', metricLabel: 'XP' },
  { key: 'vocab', label: 'Từ Vựng', metricLabel: 'điểm' },
  { key: 'grammar', label: 'Ngữ Pháp', metricLabel: 'điểm' },
  { key: 'consistency', label: 'Tính Kỷ Luật', metricLabel: 'điểm' },
  { key: 'toeic', label: 'TOEIC Tổng Hợp', metricLabel: 'điểm' },
];
